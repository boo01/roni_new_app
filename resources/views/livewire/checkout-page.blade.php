            ...
            <ul class="divide-y divide-slate-100 -mx-1">
                @foreach($summary['lines'] as $line)
                    <li class="px-1 py-2 flex justify-between gap-2 text-sm">
                        <div class="text-ink-soft min-w-0">
                            <span class="line-clamp-2">{{ $line['product']->name_ka }}</span>
                            <x-storefront.option-tags :options="$line['options']" class="mt-0.5 flex flex-wrap gap-x-2 gap-y-0" />
